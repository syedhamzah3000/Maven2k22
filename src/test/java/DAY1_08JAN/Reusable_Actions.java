...
public class Reusable_Actions {
    ...
    //creating a void click method for any web element
    ...
    /*creating a scroll method for any webpage
    public static void scrollMethod(WebDriver driver, WebElement xpath, int pixelNumber, String elementName ) {
    //declare local explicit wait
        WebDriverWait wait = new WebDriverWait(driver, 15);
